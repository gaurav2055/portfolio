...
export default function About() {
	return (
		<section id='about' className='py-16 md:py-28 max-w-6xl mx-auto px-6 lg:px-8'>
			<ScrollReveal>
			...
			<div className='grid md:grid-cols-5 gap-14 items-start'>
				...
				<ScrollReveal
					delay={0.1}
					className='md:col-span-3 space-y-4 text-[#a3a3a3] leading-relaxed'>
					<p>
						I&apos;m a Full Stack Developer with 3+ years of industry experience,
						currently pursuing my{" "}
						<span className='text-[#f0f0f0]'>
							M.S. in Computer Science at Clemson University
						</span>{" "}
						(GPA 3.85). My work spans the full stack - from crafting fast, accessible
						React interfaces to designing cloud infrastructure on AWS.
					</p>
					<p>
						At Clemson, I&apos;m the lead developer on{" "}
						<span className='text-[#22c55e]'>Prepitus</span>, an AI-powered SAT tutoring
						platform built with a graduate research team. The platform uses a custom
						Deep Knowledge Tracing (LSTM) model to personalize learning for 450+
						students across 30 knowledge components.
					</p>
					<p>
					...
					<p>
						...
						I&apos;m open to remote, hybrid, or relocation.
					</p>
				</ScrollReveal>
